...
def run_spec_dec_collect_stats(sample_idx, question_sample, device, target_model, draft_model, tokenizer, K, args, config):
    ...
    # target_generation_str = question_sample['target_generation']
