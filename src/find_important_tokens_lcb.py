...
from livecodebench_v5 import load_code_generation_dataset, extract_code, apply_llama_lcb_prompt_format, codegen_metrics
...
def find_important_tokens(
    ...
    for iteration in itertools.count():
        ...
        colored_tokens = color_replaced_tokens(current_response, draft_argmax_tokens, n_input_tokens,
...
if __name__ == '__main__':
    ...
    dataset = load_code_generation_dataset(args, shuffle=True)
        ...
        with tqdm(total=shard_end - shard_start) as pbar:
            ...
            for sample_idx in range(shard_start + len(mined_data), shard_end):            
                ...
                if ((sample_idx % args.dump_freq == (args.dump_freq - 1)) or (sample_idx == shard_end - 1)):
                    ...
                    logger.info(f'Dumped snapshot to {output_file_path=}')
